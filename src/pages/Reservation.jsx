...
import { ChevronLeft, ChevronRight, ChevronDown, CheckCircle, Clock, X } from 'lucide-react';
import { 
  format, 
  addMonths, 
  subMonths, 
...
import '../styles/ReservationOverlay.css'; // Reusing the high-fidelity styles
...
const Reservation = () => {
  ...
  return (
    <div className="reservation-page-wrapper">
      <div className="nusr-et-style page-version">
        {step === 1 ? (
          <div className="res-split-layout">
            ...
            <div className="res-right-col">
              ...
              {/* Added Contact Fields for the Page Version */}
              <div className="res-field-group">
          ...
          <div className="res-success-container">
            ...
            <p className="success-msg">Thank you, {formData.name.split(' ')[0]}. Your request for {format(selectedDate, 'MMMM d, yyyy')} has been received.</p>
            <div className="success-divider" />
            <p className="success-status">A representative will confirm your table shortly.</p>
            <button className="make-res-btn" style={{ marginTop: '40px' }} onClick={() => setStep(1)}>
